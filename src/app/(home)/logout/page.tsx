                        ...
                        <div className="w-1/2 h-1/2 flex justify-center items-center">
                            <div className="relative flex flex-col justify-center overflow-hidden">
                                <div
                                    ...
                                    <span
                                        className="absolute z-0 h-20 w-20 rounded-full bg-emerald-600 transition-all duration-300 group-hover:scale-[10]"></span>
                                    <div className="relative z-10 mx-auto max-w-md">
                                    <span
                                        className="grid h-20 w-20 place-items-center rounded-full bg-emerald-700 transition-all duration-300 group-hover:bg-emerald-500">
                                        ...
                                        <div
                                            ...
                                            <p>See you next time you need to store your files across multiple disks and networks.</p>
                                        </div>
